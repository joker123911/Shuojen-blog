...
* Delete Temporary Files：阻止微軟在後台偷偷上傳你的使用數據，節省一點點 CPU 與網路資源。
...
* Remove OneDrive：如果你沒有在用微軟的雲端硬碟，把它刪掉會讓檔案總管乾淨很多，也不會在後台佔資源。

* Remove Microsoft Edge：你剛才一直想刪的 Edge，在這裡勾選後跑一次 Run Tweaks 試試看（如果 winget 還是報錯，就用我之前教你的改地區大法）。
